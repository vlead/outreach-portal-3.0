...
class TestAddUser(TestCase):
    ...
    def test_add_user_by_noc(self):
        ...
        email.save()
        oc_user= System.do("add_user", name=Name.get_by_id(3), email=Email.get_by_id(3), session=session)
...
class TestCreateWorkshop(TestCase):
    ...
    def test_create_workshop(self):
        ...
        System.do("add_role", user = nc_user, role = Role.get_by_id(6), session = sess)
        nc_session = Session(user = nc_user, role = Role.get_by_id(6))
        System.session_set.append(nc_session)
        role_check = Role.get_by_id(6)
               
        new_workshop = System.do("create_workshop", institute = workshop_institute, name = Name(name = "Lab Workshop"), ws_target = wstarget, status = ws_status, artefacts = [], nc = NC.get_by_id(1), session = nc_session) 
...
class TestCancelWorkshop(TestCase):
    ...
    def test_cancel_workshop(self):
        ...
        System.do("add_role", user = nc_user, role = Role.get_by_id(6), session = session)
        nc_session = Session(user = nc_user, role = Role.get_by_id(6))
        System.session_set.append(nc_session)

        name1 = Name(name = "Lab Workshop")
        name1.save()
        new_workshop = System.do("create_workshop", institute = workshop_institute, name  = name1, ws_target = wstarget, status = ws_status, artefacts = [], nc = nc, session = nc_session) 
