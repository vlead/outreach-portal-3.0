...
#+BEGIN_SRC python
    def add_oc(self, institute):
        ...
        new_oc.save()
        new_role = self.add_occ_role("OCC", new_oc, None)
        new_role.save()
        return new_oc
#+END_SRC
...
#+BEGIN_SRC python
    def add_nc(self, institute, oc):
        new_nc = NC(institute=institute, hub=oc, nc_targets=[], workshops=[])
        new_nc.save()
        new_role = self.add_ncc_role("NCC", None, new_nc)
        new_role.save()
        return new_nc
#+END_SRC
