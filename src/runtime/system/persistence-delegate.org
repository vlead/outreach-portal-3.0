...
#+BEGIN_SRC python
    def add_nc(self, institute, oc, nc_targets, workshops):
        self.new_nc = NC(institute=institute, hub=oc, nc_targets=nc_targets,
                         workshops=workshops)
        self.new_nc.save()
...
#+BEGIN_SRC python
    def test_add_nc(self):
         ...
         nc_targets = []
         workshops = []
         nc = self.persistent_delegate.add_nc(institute, oc, nc_targets,
                                                workshops)
...
#+BEGIN_SRC python
    def test_nc_exists(self):
         ...
         nc_targets = []
         workshops=[]
         nc = self.persistent_delegate.add_nc(institute, oc, nc_targets, workshops)
         self.assertEqual(self.persistent_delegate.nc_exists(nc), True)
#+END_SRC
