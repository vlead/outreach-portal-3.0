...
#+BEGIN_SRC python
    def upload_artefact(self, workshop, new_artefact):
        ...
        pending_approval = self.get_status(name="pending for approval")
        workshop.set(status = pending_approval)
        workshop.save()
        return workshop
#+END_SRC
**** Tests
...
#+BEGIN_SRC python
    def test_upload_artefact(self):
        ...
        self.assertEqual(workshop.get("status").get("name"), pending_approval.get("name"))
