...
class TestAddUser(TestCase):
    ...
    def test_add_user_noc_by_admin(self):
        ...
        noc_user= System.do("add_user", name=name, email=email,
                            session=session)
    ...
    def test_add_user_by_noc(self):
        ...
        oc_user = System.do("add_user", name=name1, email=email1,
                             session=session_noc)
...
class TestDeleteUser(TestCase):
    ...
    def test_delete_admin_user(self):
        ...
        other_admin_user= System.do("add_user", name=name, email=email,
                                    session=session)
    ...
    def test_delete_user_by_occ(self):
        ...
        nc_user = System.do("add_user", name=name1, email=email1,
                             session=session)
    ...
    def test_delete_user_by_noc(self):
        ...
        noc_user = System.do("add_user", name=name1, email=email1,
                              session=session)
...
class TestUpdateUser(TestCase):
    ...
    def test_update_user_by_admin(self):
        ...
        other_user= System.do("add_user", name=name, email=email,
                               session=session)

        System.do("update_user",name=Name(name="john"), user=other_user,
                   session=session)
    ...
    def test_update_user_by_occ(self):
        ...
        institute = System.do("create_institute",name="IIT",address="Madras",
                               session=session)
        oc = System.do("create_oc",institute=institute,session=session,
                        spokes=[], oc_target = None)
...
class TestUpdateInstitute(TestCase):
    ...
    def test_update_institute(self):
        ...
        System.do("update_institute",name="NITK",institute=institute,
                   session=session)
