...
class TestAddUser(TestCase):
    ...
    def test_add_user_by_admin(self):
        ...
        user=User(name=Name(name="me"),email=Email(email="abc@gmail.com"),roles=[],user_status="active")
    ...
    def test_add_user_noc_by_admin(self):
        ...
        noc_user=User(name=Name(name="nocuser"),email=Email(email="abc@gmail.com"),roles=[],user_status="active")
    ...
    def test_add_user_by_noc(self):
        ...
        oc_user=User(name=Name(name="ocuser"),email=Email(email="mary@gmail.com"),roles=[],user_status="active")
...
class TestDeleteUser(TestCase):
    ...
    def test_delete_admin_user(self):
        ...
        other_admin_user=User(name=Name(name="me"),email=Email(email="abc@gmail.com"),roles=[],user_status="active")
    ...
    def test_delete_user_by_occ(self):
        ...
        oc_user=User(name=Name(name="maryoc"),email=Email(email="mary@gmail.com"),roles=[],user_status="active")
        ...
        nc_user=User(name=Name(name="xyznc"),email=Email(email="xyz@gmail.com"),roles=[],user_status="active")
    ...
    def test_delete_user_by_noc(self):
        ...
        noc_user=User(name=Name(name="xyznc"),email=Email(email="xyz@gmail.com"),roles=[],user_status="active")
...
class TestUpdateUser(TestCase):
    ...
    def test_update_user_by_admin(self):
        ...
        other_user=User(name=Name(name="me"),email=Email(email="abc@gmail.com"),roles=[],user_status="active")
    ...
    def test_update_user_by_occ(self):
        ...
        oc_user=User(name=Name(name="useroc"),email=Email(email="useroc@gmail.com"),roles=[],user_status="active")
        ...
        #create nc
        nc = System.do("create_nc",institute=institute,hub=oc,session=session, nc_target = None, workshops = [])
        nc_user=User(name=Name(name="usernc"),email=Email(email="usernc@gmail.com"),roles=[],user_status="active")
    ...
    def test_update_user_by_noc(self):
        ...
        noc_user=User(name=Name(name="usernoc"),email=Email(email="usernoc@gmail.com"),roles=[],user_status="active")
...
class login():
    ...
    def state_check(args):
        ...
        active_user_set= filter(lambda x: x.get("user_status")=="active", System.user_set)
...
class TestCreateWorkshop(TestCase):
    ...
    def test_create_workshop(self):
        ...
        wstarget = WSTarget(usage = 4000, participants = 200, experiments = 20, date = target_date)
        session = Session(user=login_user,role=Role.admin)
        System.session_set.append(session)
        ws_status = Status.pending
        nc_user=User(name=Name(name="ncuser"),email=Email(email="ncuser@gmail.com"),roles=[],user_status="active")
...
class TestRescheduleWorkshop(TestCase):
    ...
    def test_reschedule_workshop(self):
        ...
        new_wstarget = WSTarget(usage = 3000, participants = 200, experiments = 20, date = new_target_date)
...
class TestConductWorkshop(TestCase):
    ...
    def test_conduct_workshop(self):
        ...
        self.assertEqual(new_workshop.get("status").get("name"), Status.completed.get("name"))
        self.assertEqual(nc.get("workshops")[0].get("status").get("name"), Status.completed.get("name"))
...
class TestApproveWorkshop(TestCase):
    ...
    def test_approve_workshop(self):
        ...
        oc_user=User(name=Name(name="ocuser"),email=Email(email="ocuser@gmail.com"),roles=[],user_status="active")
...
class TestDeleteArtefact(TestCase):
    ...
    def test_delete_artefact(self):
        ...
        ws_status = Status.pending
        nc_user=User(name=Name(name="ncusernew"),email=Email(email="ncusernew@gmail.com"),roles=[],user_status="active")
        nc_user.set(roles=[Role(name = "NCC", centre_oc = oc, centre_nc = nc)])
        System.do("add_user",user=nc_user,session=session)
        nc_session = Session(user = nc_user, role = Role(name = "NCC", centre_oc = oc, centre_nc = nc))
...
class MakeUser():
    ...
    def action(args):
        ...
        name = args["name"]
        email = args["email"]
        u = User(name=Name(name=name),email=Email(email=email),roles=[],user_status="active")
