...
class CreateNC():
    ...
    def action(args):
        ...
        nc_targets = args['nc_targets']
        workshops = args["workshops"]
        new_nc = System.delegate.add_nc(institute, oc, nc_targets, workshops)
...
from runtime.objects.entities import is_user, is_session, is_role, is_email, \
    ...
    is_artefact, are_oc_targets_or_empty_list, \
    are_nc_targets_or_empty_list, Session
