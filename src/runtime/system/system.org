...
class CreateNC():
    arg_types = {"institute":is_institute,"hub":is_oc,"session":is_session,
                  "nc_target" : is_nctarget, "workshops": are_workshops_or_empty_list}
    arity_and_type_checks_needed = True
    @staticmethod
    def auth_check(args):
        session = args['session']
...
from runtime.objects.entities import is_user, is_session, is_role, is_email, \
    ...
    is_octarget, is_oc, is_nctarget, are_workshops_or_empty_list, is_wstarget,\
    are_artefacts_or_empty_list, is_status, is_nc, is_workshop_or_none, is_wst, \
    is_artefact, Session
