...
class TestAddUser(TestCase):
    ...
    def test_add_user_by_noc(self):
        ...
        institute = System.do("create_institute", institute = inst,
                               session=session)
        oc = System.do("create_oc", institute = institute,
                        session = session,
...
class TestDeleteUser(TestCase):
    ...
    def initialize_role_set(self):
        ...
        self.guest_role = Role(name="guest", centre_oc=None, centre_nc=None)
        self.noc_role = Role(name="noc", centre_oc=None, centre_nc=None)
        self.reviewer_role = Role(name="reviewer", centre_oc=None,
                                  centre_nc=None)
        self.admin_role.save()
        self.guest_role.save()
        self.reviewer_role.save()
...
class TestCreateOC(TestCase):
    ...
    def test_create_oc(self):
        ...
        institute = System.do("create_institute", institute=institute, session=session)
        oc = System.do("create_oc", institute=institute, spokes=[],
                        session=session, oc_targets=[])
...
class TestCreateNC(TestCase):
    ...
    def test_create_nc(self):
        ...
        nc = System.do("create_nc", institute=institute, hub=oc,
                        session=session, nc_targets=[], workshops = [])
        self.assertEqual(NC.get_by_id(1).get('institute').get("name"),
                             institute.get("name"))
        self.assertEqual(OC.get_by_id(1).get('spokes')[0].get("institute").get("name"),
