...
class TestAddRole(TestCase):
    ...
    def test_add_role(self):
        ...
        System.do("add_role",user=login_user,role=Role.get_by_id(2),
                   session=sess)
...
class TestCreateInstitute(TestCase):
    ...
    def test_create_institute(self):
        ...
        institute = System.do("create_institute", institute=institute,
                                  session=session)
        self.assertEqual(Institute.get_by_id(1).get("name"), "IIIT")


    def test_create_institute_raises_arity_error(self):
        print "test_create_institute_raises_arity_error"
        login_user = User.get_by_id(1)
        login_role = Role.get_by_id(1)
        session = System.do("login", user=login_user, role=login_role)
        ...
        with self.assertRaises(ArityError):
            System.do("create_institute", institute=institute)

    def test_create_institute_raises_type_check_error(self):
        print "test_create_institute_raises_type_check_error"
        login_user = User.get_by_id(1)
        login_role = Role.get_by_id(1)
        session = System.do("login", user=login_user, role=login_role)
        ...
        with self.assertRaises(TypeError):
            System.do("create_institute", institute=session, session=session)

    def test_create_institute_raises_auth_error(self):
        print "test_create_institute_raises_auth_error"
    ...
    def test_create_institute_raises_state_error_with_no_session(self):
        print "test_create_institute_raises_state_error_with_no_session"
        ...
        with self.assertRaises(StateError):
            System.do("create_institute", institute=institute, session=session)

    def test_create_institute_raises_state_error_with_existing_institute(self):
        print "test_create_institute_raises_state_error_with_existing"
        "_institute"
        admin_role = Role.get_by_id(1)
        admin_user = User.get_by_id(1)
        session = Session(user=admin_user, role=admin_role)
...
class TestCreateOC(TestCase):
    ...
    def test_create_oc_raises_arity_error(self):
        print "test_create_oc_raises_arity_error"
        login_user = User.get_by_id(1)
        login_role = Role.get_by_id(1)
        session = System.do("login", user=login_user, role=login_role)
        ...
        with self.assertRaises(ArityError):
            System.do("create_oc", institute=institute)

    def test_create_oc_raises_type_check_error(self):
        print "test_create_oc_raises_type_check_error"
        login_user = User.get_by_id(1)
        login_role = Role.get_by_id(1)
        session = System.do("login", user=login_user, role=login_role)
        ...
        with self.assertRaises(TypeError):
            System.do("create_oc", institute=session, session=session)


    def test_create_oc_raises_auth_error(self):
        print "test_create_oc_raises_auth_error"
        ...
        institute = Institute(name="IIIT", address="Hyderabad")
        institute.save()
        oc = System.do("create_oc", institute=institute, session=admin_session)
    ...
    def test_create_oc_raises_state_error_with_no_session(self):
        print "test_create_oc_raises_state_error_with_no_session"
        ...
        with self.assertRaises(StateError):
            System.do("create_oc", institute=institute, session=session)

    def test_create_oc_raises_state_error_without_an_institute(self):
        print "test_create_oc_raises_state_error_without_an_institute"
    ...
    def test_create_oc_raises_state_error_with_existing_oc(self):
        print "test_create_oc_raises_state_error_with_existing_oc"
...
class TestCreateNC(TestCase):
    ...
    def test_create_nc_raises_arity_error(self):
        print "test_create_nc_raises_arity_error"
        login_user = User.get_by_id(1)
        login_role = Role.get_by_id(1)
        session = System.do("login", user=login_user, role=login_role)
        ...
        with self.assertRaises(ArityError):
            System.do("create_nc", institute=institute, hub=oc)

    def test_create_nc_raises_type_check_error(self):
        print "test_create_nc_raises_type_check_error"
        login_user = User.get_by_id(1)
        login_role = Role.get_by_id(1)
        session = System.do("login", user=login_user, role=login_role)
        ...
        with self.assertRaises(TypeError):
            System.do("create_nc", institute=session, hub=oc, session=session)

    def test_create_nc_raises_auth_error(self):
        print "test_create_nc_raises_auth_error"
    ...
    def test_create_nc_raises_state_error_with_no_session(self):
        print "test_create_nc_raises_state_error_with_no_session"
        ...
        with self.assertRaises(StateError):
            System.do("create_nc", institute=institute, hub=oc, session=session)

    def test_create_nc_raises_state_error_without_an_institute(self):
        print "test_create_nc_raises_state_error_without_an_institute"
        ...
        with self.assertRaises(StateError):
            System.do("create_nc", institute=nc_institute, hub=oc, session=session)

    def test_create_nc_raises_state_error_with_existing_nc(self):
        print "test_create_nc_raises_state_error_with_existing_nc"
...
class TestCreateWorkshop(TestCase):
    ...
    def test_create_workshop(self):
        ...
        workshop_institute = System.do("create_institute", institute = inst,
                                        session = sess)
        
        oc = System.do("create_oc",institute= Institute.get_by_id(1),spokes=[],
                        session=sess, oc_target = None)

        nc = System.do("create_nc",institute= Institute.get_by_id(1),
                        hub=oc,session=sess, nc_target = None, workshops = [])
        ...
        nc_user = System.do("add_user", user=user, session = sess)
...
class TestCancelWorkshop(TestCase):
    ...
    def test_cancel_workshop(self):
        ...
        inst = Institute(name="NITK",address="Surathkal")
        workshop_institute = System.do("create_institute", institute = inst, session = sess)
...
class TestApproveWorkshop(TestCase):
    ...
    def test_approve_workshop(self):
        ...
        user = User(name=Name.get_by_id(3), email= Email.get_by_id(3), roles= [guest_role],
                    user_status="active")
        oc_user= System.do("add_user", user=user, session=sess)

        occ_role =  Role(name="OCC",centre_oc=oc,centre_nc=None)
        if occ_role:
            nc_user.append_role(occ_role)
...
class TestRejectWorkshop(TestCase):
    ...
    def test_reject_workshop(self):
        ...
        occ_role =  Role(name="OCC",centre_oc=oc,centre_nc=None)
        if occ_role:
            oc_user.append_role(occ_role)

        oc_session = Session(user = nc_user, role = occ_role)
        System.session_set.append(oc_session)
