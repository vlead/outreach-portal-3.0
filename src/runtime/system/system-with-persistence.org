...
class TestCreateOC(TestCase):
    ...
    def test_create_oc(self):
        ...
        login_role = Role.get_by_id(1)
        sess = System.do("login",user=login_user,role=login_role)
        inst = Institue(name="IIIT",address="Hyderabad")
        institute = System.do("create_institute",institute = inst,session=sess)
...
class TestCreateWorkshop(TestCase):
    ...
    def test_create_workshop(self):
        ...
        institute = System.do("create_institute",institute = inst, session=sess)
        institute.save()
        inst = Institue(name="NITK",address="Surathkal")
...
class TestRejectWorkshop(TestCase):
    ...
    def test_reject_workshop(self):
        ...
        System.session_set.append(session)
        inst = Institute(name = "IIIT", address = "Hyderabad")
        institute = System.do("create_institute",name="IIIT", institute = inst, session=session)
        institute.save()
        inst = Institute(name = "NITK", address = "Surathkal")
        workshop_institute = System.do("create_institute", institute=inst, session = session)
        workshop_institute.save()
...
class TestDeleteArtefact(TestCase):
    ...
    def test_delete_artefact(self):
        ...
        System.session_set.append(session)
        inst = Institute(name = "IIIT", address = "Hyderabad")
        institute = System.do("create_institute",institution = inst, session=session)
        institute.save() 
        inst = Institute(name = "NITK", address = "Surathkal")
        workshop_institute = System.do("create_institute", institute = inst, session = session)
        workshop_institute.save()
