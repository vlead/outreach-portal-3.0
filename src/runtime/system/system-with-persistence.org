...
class AddUser():
    ...
    def auth_check(args):
        ...
        if not (System.is_session_admin(session) or System.is_session_OCC(session) or
    ...
    def action(args):
        ...
        user = User(name=user_name , email=user_email , roles=[rl] ,
                    user_status="active")
        user.save()
        System.user_set = User.query.all()
        return user
...
class TestAddUser(TestCase):
    ...
    def test_add_user_noc_by_admin(self):
        ...
        email = Email(email="abc@gmail.com")
        email.save()
        noc_user=System.do("add_user", name=Name.get_by_id(2),
                            email=Email.get_by_id(2), session=session)
    ...
    def test_add_user_by_noc(self):
        ...
        email.save()
        oc_user= System.do("add_user", name=Name.get_by_id(3),
                            email=Email.get_by_id(3), session=session_noc)
...
class TestDeleteUser(TestCase):
    ...
    def test_delete_admin_user(self):
        ...
        name.save()
        email.save()
        other_admin_user = System.do("add_user", name = Name.get_by_id(2),
                                     email = Email.get_by_id(2),
                                     session = session)
    ...
    def test_delete_user_by_occ(self):
        ...
        name.save()
        email.save()
        oc_user= System.do("add_user", name=Name.get_by_id(2),
                            email=Email.get_by_id(2), session=session)
        oc_user.save()
        ...
        nc_user= System.do("add_user", name=Name.get_by_id(3),
                            email=Email.get_by_id(3), session=session)
        nc_user.save()
    ...
    def test_delete_user_by_noc(self):
        ...
        email1 = Email(email="xyz@gmail.com")
        email1.save()
        noc_user=System.do("add_user", name=Name.get_by_id(3),
                            email=Email.get_by_id(3), session=session)
...
class TestCreateOC(TestCase):
    ...
    def test_create_oc(self):
        ...
        institute.save()
        oc.save()
        self.assertEqual(OC.get_by_id(1).get('institute'),
                         Institute.get_by_id(1))
...
class CreateNC():
    arg_types = {"institute":is_institute,"hub":is_oc,"session":is_session,
                 "workshops":are_workshops, "nc_target":is_nctarget}
    arity_and_type_checks_needed = True
    @staticmethod
    def auth_check(args):
        session = args['session']
    ...
    def action(args):
        ...
        new_nc = NC(institute=institute,hub=oc, workshops = workshops,
                    nc_target = nc_target)
        new_nc.save()
...
class TestCreateWorkshop(TestCase):
    ...
    def test_create_workshop(self):
        ...
        nc_user = System.do("add_user",name = name, email = email,
                             session = sess)
