...
#+BEGIN_SRC python
    def test_get_users(self):
         ...
         self.assertEqual(len(self.obj_handler.get_users()), 1)
...
#+BEGIN_SRC python
    def test_get_roles(self):
         ...
         self.assertEqual(len(self.obj_handler.get_roles()), 4)
...
#+BEGIN_SRC python
    def test_get_institutes(self):
         ...
         ins = Institute(name='IIIT',address='Hyderabad')
         inst = self.obj_handler.add_institute(ins)
         self.assertEqual(len(self.obj_handler.get_institutes()), 1)
...
#+BEGIN_SRC python
    def test_get_ocs(self):
         ...
         oc1 = OC(institute=Institute(name="IIITH",address="Hyderabad"),spokes=[], oc_target = None)
         oc = self.obj_handler.add_oc(oc1)
         self.assertEqual(len(self.obj_handler.get_ocs()), 1)
...
#+BEGIN_SRC python
    def test_get_ncs(self):
         ...
         nc1 = NC(institute=Institute(name="IIITH",address="Hyderabad"), hub=oc, nc_target = None, workshops=None)
         nc = self.obj_handler.add_nc(nc1)
         self.assertEqual(len(self.obj_handler.get_ncs()), 1)
...
#+BEGIN_SRC python
    def test_get_workshops(self):
         ...
         workshop = Workshop(institute = ins, 
                            ...
                            a_usage = 0)
         workshop = self.obj_handler.add_workshop(workshop)
         self.assertEqual(len(self.obj_handler.get_workshops()), 1)
...
#+BEGIN_SRC python
    def test_user_exists(self):
         ...
         self.assertEqual(self.persistent_handler.user_exists(user), True)
...
#+BEGIN_SRC python
    def test_add_user(self):
         ...
         user = self.persistent_handler.add_user(user)
         self.assertEqual(self.persistent_handler.user_exists(user), True)
...
#         oc = handler.add_oc(oc1)
         self.assertEqual(self.persistent_handler.oc_exists(oc1), True)
#+END_SRC
...
#+BEGIN_SRC python
    def test_add_oc(self):
         ...
         ins.save()
         oc1 = OC(institute=ins.get_by_id(1),spokes=[], oc_target = None)
         oc = self.persistent_handler.add_oc(oc1)
         self.assertEqual(self.persistent_handler.oc_exists(oc), True)
...
#+BEGIN_SRC python
    def test_nc_exists(self):
         ...
         nc1.save()
         self.assertEqual(self.persistent_handler.nc_exists(nc1), True)
...
#+BEGIN_SRC python
    def test_add_nc(self):
         ...
         oc.save()   
         nc1 = NC(institute=ins, hub=oc, nc_target = None, workshops=[])
         nc = self.persistent_handler.add_nc(nc1)
         self.assertEqual(self.persistent_handler.nc_exists(nc), True)
...
#+BEGIN_SRC python
    def test_add_workshop(self):
        ...
        workshop.save()
        workshop = self.persistent_handler.add_workshop(workshop)
        self.assertEqual(self.persistent_handler.workshop_exists(workshop), True)
...
#+BEGIN_SRC python
    def test_role_exists(self):
         ...
         self.assertEqual(self.persistent_handler.role_exists(role), True)
...
#+BEGIN_SRC python
    def test_add_role(self):
         print "test_add_role"
         role = Role(name='user',centre_oc=None,centre_nc=None)
         role = self.persistent_handler.add_role(role)
         self.assertEqual(self.persistent_handler.role_exists(role), True)
...
#+BEGIN_SRC python
    def test_institute_exists(self):
         print "test_institute_exists"
         ins = Institute(name='IIIT',address='Hyderabad')
         inst = self.persistent_handler.add_institute(ins)
         self.assertEqual(self.persistent_handler.institute_exists(inst), True)
