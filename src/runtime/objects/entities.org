...
WSTarget = ClassTemplate.mk_class("NCTarget")
...
#+NAME: class_Workshop
#+BEGIN_SRC python
Workshop.add_attributes(name=is_name, 
                         institute=is_institute, 
                         ws_target=is_ws_target_or_none, 
                         nc=is_nc, 
...
class TestWorkshop(TestCase):
    ...
    def test_instatiate_Workshop(self):
        ...
        # oc_target = OCTarget(usage=400, date=date, nctargets = [])
        # nc_target = NCTarget(usage=400, date=date, 
        #                      oc_target=oc_target, wstargets=[])
        # wstarget_check = WSTarget(usage=4000, participants=200, experiments=20,
    ...
    def test_equality_on_workshop(self):
        ...
        workshop3 = Workshop(name=Name(name="Test workshop"), 
                             institute=Institute(name="IIITH", 
                             address="Hyderabad"), 
                             nc=nc,
                             ws_target=None,
...
class TestArtefact(TestCase):
    ...
    def test_instantiate_artefact(self):
        ...
        artefact = Artefact(name="attendance", 
                     path="/home/file.txt", 
                     file_type=Type(name="attendance"),
                     workshop=None)
...
WSTarget.__eq__ = lambda self, other: \
                  isinstance(other, self.__class__) and \
                  self.get("workshop") == other.get("workshop") and \
                  self.get("date") == other.get("date")
...
class TestWSTarget(TestCase):
    ...
    def test_equality_of_wstarget(self):
        ...
        status = Status(name="pending")
        workshop_1 = Workshop(name=Name(name="Test workshop"), 
                                institute=Institute(name="IIITH", 
                                                    address="Hyderabad"), 
                                nc=nc,
                                ws_target=None,
        ...
        workshop_2 = Workshop(name=Name(name="Test workshop"), 
                                institute=Institute(name="IIITH", 
                                                    address="Hyderabad"), 
                                nc=nc,
                                ws_target=None,
