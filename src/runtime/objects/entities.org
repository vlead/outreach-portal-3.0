...
Institute = ClassTemplate.mk_class("Institute", name=check_alphabetic_str, address=check_str)
...
class TestInstitute(TestCase):
    ...
    def test_instantiate_institute(self):
        ...
        self.assertEqual(check_role(institute_ex), institute_ex)
        self.assertEqual(check_role(institute_ex).name, "IIIT")
