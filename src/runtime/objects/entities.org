...
NCTarget = ClassTemplate.mk_class("NCTarget", usage = is_int, date = is_date, wstargets = are_wstargets )
...
check_octarget = check_pred(is_octarget)
...
class TestOCTarget(TestCase):
    ...
    def test_instantiate_octarget(self):
        ...
        self.assertEqual(is_octarget(octarget_check), True)
...
def is_octarget(value):
    if value == None or is_inst(OCTarget):
        return True
    else:
        return False
...
class TestOC(TestCase):
    ...
    def test_sets_spokes_on_OC(self):
        ...
        nc = NC(institute=Institute(name="HCU",address="Hyderabad"), hub=oc, nc_target = None)
...
def is_nctarget(value):
    if value == None or is_inst(NCTarget):
        return True
    else:
        return False
    

NC= ClassTemplate.mk_class("NC", institute=is_institute, hub=is_oc, nc_target = is_nctarget)
...
class TestNC(TestCase):
    ...
    def test_instatiate_NC(self):
        ...
        nc = NC(institute=Institute(name="HCU",address="Hyderabad"), hub=OC(institute=Institute(name="IIITH", address="Hyderabad"),spokes=[], oc_target = None), nc_target = None)
...
def is_wstarget(value):
    if value == None or is_inst(WSTarget):
        return True
    else:
        return False

Workshop = ClassTemplate.mk_class("Workshop", name=is_name, institute=is_institute, ws_target = is_wstarget)
...
class TestWorkshop(TestCase):
    ...
    def test_instatiate_Workshop(self):
        print "test_instantiate_user"
        workshop = Workshop(name=Name(name="Test workshop"),institute=Institute(name="IIITH",address="Hyderabad", wstarget = None))
