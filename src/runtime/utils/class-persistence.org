...
class TestPersistence(TestCase):
    ...
    def testCreationOfAPersistentClass(self):
        ...
        ClassPersistenceTemplate.mk_persistent(entities.Name, **args)
        self.setUp()
        p_name = entities.Name(name="Jimi Hendrix")
        p_name.save()
        name = entities.Name.get_by_id(1)
        self.assertEqual(name.get("name"), "Jimi Hendrix")
        p_name.update(name="Bo Didley")
        names = entities.Name.get_all()
