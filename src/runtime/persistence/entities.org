...
class TestPersistenceOC(TestCase):
    ...
    def test_create_oc(self):
        ...
        oc = OC(institute=Institute(name="IIIT",address="Hyderabad"), spokes=[])
        oc.save()
...
class TestPersistenceNC(TestCase):
    ...
    def test_create_nc(self):
        ...
        oc = OC(institute=Institute(name="NIT",address="Suratkal"), spokes=[])
        oc.save()
        nc = NC(institute=Institute(name="IIIT",address="Hyderabad"), hub=OC.get_by_id(1))
        nc.save()
...
args = {"__tablename__": "roles",
        "id": db.Column(db.Integer, primary_key=True),
        "name": db.Column(db.String(128), unique=True, nullable=False),
        "oc_centre_id": db.Column(db.Integer, db.ForeignKey('oc.id'), nullable=True),
        "nc_centre_id": db.Column(db.Integer, db.ForeignKey('nc.id'), nullable=True),
	}
...
class TestPersistenceRole(TestCase):
    ...
    def test_create_role(self):
        ...
        ro = Role(name="admin",centre=None)
