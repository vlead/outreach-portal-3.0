...
class TestWSTarget(TestCase):
    ...
    def test_instantiate_wstarget(self):
        ...
        wstarget_check = WSTarget(usage = 4000, participants = 200, experiments = 20, date = datetime.datetime.strptime("30-06-2016", "%d-%m-%Y").date())
        wstarget_check.save()
...
class TestNCTarget(TestCase):
    ...
    def test_instantiate_nctarget(self):
        ...
        nctarget_check = NCTarget(usage = 4000, date = datetime.datetime.strptime("30-06-2016", "%d-%m-%Y").date(), wstargets = [])
        nctarget_check.save()
...
class TestPersistenceOC(TestCase):
    ...
    def test_get_spokes_of_oc(self):
        ...
        nc1 = NC(institute=Institute.get_by_id(2), hub=OC.get_by_id(1), nc_target = None)
        nc1.save()

        nc2 = NC(institute=Institute.get_by_id(3), hub=OC.get_by_id(1), nc_target = None)
        nc2.save()
...
class TestPersistenceNC(TestCase):
    ...
    def test_create_nc(self):
        ...
        oc = OC(institute=Institute.get_by_id(1), spokes=[], oc_target = None)
        oc.save()
        nc = NC(institute=Institute.get_by_id(2), hub=OC.get_by_id(1), nc_target = None)
        nc.save()
...
class TestPersistenceRole(TestCase):
    ...
    def test_create_nc_role(self):
        ...
        nc = NC(institute=Institute.get_by_id(2), hub=oc, nc_target = None)
        nc.save()
...
#+begin_src python
class CreateOC():
    arg_types = {"institute":is_institute,"spokes":is_spokes, "session":is_session, "oc_target": is_octarget}
    arity_and_type_checks_needed = True
    @staticmethod
    def auth_check(args):
        session = args['session']
...
class CreateNC():
    ...
    def action(args):
        ...
        oc = args['hub']
        nc_target = args['nc_target']
        new_nc = NC(institute=institute,hub=oc, nc_target = None)
