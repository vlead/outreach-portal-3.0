...
TYPE Email
TYPE Name
TYPE Role = {admin + guest + reviewer + OCC(OC) + NCC(NC)}
...
;;; Primary state variables
 ...
 name-set                : set[Name]               ; set of names in the system
 nc-set                  : set[NC]                 ; set of nodal centres
 email-set               : set[Email]              ; set of emails in the system
 session-set             : set[Session]            ; set of sessions in the system
 oc-set                  : set[OC]                 ; set of outreach centres in the system
 institution-set         : set[Institution]        ; set of institutions in the system
...
** Derived Entity sets
#+BEGIN_SRC spec :tangle spec.txt
  oc-institute-set  : set[institute] = oc-set.host
  nc-institute-set  : set[institute] = nc-set.host
...
*** Parameters
    s:Session, old-data:String, time-stamp:String, pk-old:Integer,
    pk-current:Integer, entity:String 
...
*** Remarks
    ...
    pk-old contains the id of the object being changed
    pk-current contains the id of the session of the user who is changing the object
