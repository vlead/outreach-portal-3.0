...
*** Actor credentials
#+BEGIN_SRC spec :tangle spec.txt
    s.role==admin or s.role==NOC s.role==OCC(oc) where oc:oc-set
#+END_SRC   
...
*** Actor credentials
#+BEGIN_SRC spec :tangle spec.txt
    s.role == admin or s.role == NOC or s.role == OCC(oc) or s.role == NCC(nc)
#+END_SRC   
*** Referential Integrity
#+BEGIN_SRC spec :tangle spec.txt
    s:session-set
...
#+BEGIN_SRC spec :tangle spec.txt
     Institute is added to i.institute
     We also check that the edited institute does not exist in the institute set.
#+END_SRC   
...
*** Parameters
#+BEGIN_SRC spec :tangle spec.txt
    s:Session, old-data:String, time-stamp:String, updating-entity-id:Integer,
    current-session-id:Integer, entity:String , operation:String 
#+END_SRC   
*** Referential Integrity
#+BEGIN_SRC spec :tangle spec.txt
    s:session-set
