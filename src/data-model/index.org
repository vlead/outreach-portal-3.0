...
[activeStatus, user]   : User+    >    activeStatus!
...
#+BEGIN_SRC spec :tangle spec.txt
  ...
  logged-in-user-set : session-set.user    ; set of logged in users
  admin-user-set     : user-set.role==admin; set of admin users
  active-user-set    : user-set.activeStatus==True; set of active users
  inactive-user-set  : user-set.activeStatus==False ; set of inactive users
#+END_SRC
* Operations 
